...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 14, 2022 at 03:17 PM
...
CREATE TABLE IF NOT EXISTS `agree` (
  `idagree` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `agree_image` varchar(255) NOT NULL DEFAULT '',
  `agree_title` varchar(255) NOT NULL DEFAULT '',
  `agree_desc` mediumtext,
...
INSERT INTO `agree` (`idagree`, `agree_image`, `agree_title`, `agree_desc`, `question_id`) VALUES
(0, 'resources/images/question_images/q1/agree.svg', '찬성', '노약자나 장애인, 어린이 등 사회 위약층 등에게 안전에 도움이 \r\n되어 사회 공공에 이익이 됩니다.', 1),
(1, 'resources/images/question_images/q2/agree.svg', '찬성', '전과자들의 범죄 발생률이 줄어들어 사회 안전에\r\n도움이 됩니다.', 2),
(2, 'resources/images/question_images/q3/agree.svg', '찬성', '순찰하는 경찰 수가 증가하면 사건 사고가 줄어들어 사회가\r\n안전해질 것입니다.', 3),
(3, 'resources/images/question_images/q4/agree.svg', '찬성', '앱을 통해 생성된 영상으로 그리움을 달래 우울증 치료에\r\n도움이 됩니다.', 4),
(4, 'resources/images/question_images/q5/agree.svg', '찬성', '적은 비용으로 도시를 깨끗하게 관리할 수 있습니다.', 5),
(5, 'resources/images/question_images/q6/agree.svg', '찬성', '빠르고 적은 비용으로 배달과 택배가 가능해집니다.', 6),
(6, 'resources/images/question_images/q7/agree.svg', '찬성', '전쟁에서 이기고 우리를 지키기 위해서 인공지능 무기를\r\n개발해야 합니다.', 7),
(7, 'resources/images/question_images/q8/agree.svg', '찬성', '가장 아름다운 작품이라며 인공지능이 생성한 것도 \r\n예술 작품으로 보고 시상 해야 합니다.', 8),
(8, 'resources/images/question_images/q9/agree.svg', '찬성', '아이들에게 정서적인 안정감까지 줄 수 있어 돌봄의 목적에\r\n충실합니다.', 9);

-- --------------------------------------------------------

--
-- Table structure for table `disagree`
--

DROP TABLE IF EXISTS `disagree`;
CREATE TABLE IF NOT EXISTS `disagree` (
  `iddisagree` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `disagree_image` varchar(255) NOT NULL DEFAULT '',
  `disagree_title` varchar(255) NOT NULL DEFAULT '',
  `disagree_desc` mediumtext,
  `question_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`iddisagree`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=euckr;

--
-- Dumping data for table `disagree`
--

INSERT INTO `disagree` (`iddisagree`, `disagree_image`, `disagree_title`, `disagree_desc`, `question_id`) VALUES
(0, 'resources/images/question_images/q1/disagree.svg', '반대', '개인의 사생활이 노출될 수 있습니다.', 1),
(1, 'resources/images/question_images/q2/disagree.svg', '반대', '전과자는 이미 죄에 대한 처벌을 받았습니다. 범죄자의 인권도\r\n존중되어야 합니다.', 2),
(2, 'resources/images/question_images/q3/disagree.svg', '반대', '경찰 로봇이 사건을 진압할 때 경찰 로봇에 의해 사람이 다칠 수\r\n있습니다.', 3),
(3, 'resources/images/question_images/q4/disagree.svg', '반대', '앱을 통해 손쉽게 불법 동영상을 만들어 사회에 사기 범죄가\r\n늘어나게 될 것입니다.', 4),
(4, 'resources/images/question_images/q5/disagree.svg', '반대', '노인 일자리가 사라지면 사회 취약 계층인 노인들의 생계에\r\n어려움이 생길 수 있습니다.\r\n', 5),
(5, 'resources/images/question_images/q6/disagree.svg', '반대', '택배와 배달 업무에 종사하고 있는 많은 사람들이 \r\n일자리를 잃어 사회문제가 될 것입니다.', 6),
(6, 'resources/images/question_images/q7/disagree.svg', '반대', '어떠한 경우에도 인공지능 기기가 사라믈 해치게 해서는\r\n안됩니다.', 7),
(7, 'resources/images/question_images/q8/disagree.svg', '반대', '인간의 창의성이 담기지 않은 창작물은 작품으로 볼 수\r\n없습니다.', 8),
(8, 'resources/images/question_images/q9/disagree.svg', '반대', '정서적인 교감은 인간 고유의 것으로 로봇에게 인간 고유\r\n영역을 대신하게 해서는 안됩니다.', 9);
